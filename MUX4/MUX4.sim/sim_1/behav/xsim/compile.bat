...
REM
REM Generated by Vivado on Sun Aug 06 20:37:34 +1000 2023
...
echo "xvhdl --incr --relax -prj mux4_sim_vhdl.prj"
call xvhdl  --incr --relax -prj mux4_sim_vhdl.prj -log xvhdl.log
